...
public static void main(String args[]) {
        ...
        ///////////////The highest populated city of each country
        Map<String, String> highestPopulated = allCountries.entrySet().stream()
                .collect(Collectors.toMap(
                        entry -> entry.getValue().getName(),
                        entry -> entry.getValue().getCities().stream()
                        .max(Comparator.comparing(City::getPopulation))
                        .map(City::getName)
                        .orElse("No Cities")
                ));
        
        highestPopulated.forEach((country, city) -> {
        ...
        City highestPopulatedCapitalCity = allCountries.entrySet().stream()
                .filter(entry -> entry != null && entry.getValue() != null && entry.getValue().getCities() != null)
                .map(entry -> entry.getValue().getCities().stream()
                        .filter(city -> city != null && city.getId() == entry.getValue().getCapital())
        ...
        System.out.println("Highest Populated Capital City: " + highestPopulatedCapitalCity);
